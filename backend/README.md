...
## Project Structure
    ...
    ├── tstdanielrevpreview_1  # Django project configurations
...
1. Clone this repo and `cd tstdanielrevpreview_1`
...
2. Clone this repo and `cd tstdanielrevpreview_1`
